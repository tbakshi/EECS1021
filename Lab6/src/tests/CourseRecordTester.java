...
public class CourseRecordTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("cr1 and cr2 have the same insturctor: " + (cr1.getInstructor() == cr2.getInstructor()));
		System.out.println("cr2 and cr3 have the same insturctor: " + (cr2.getInstructor() == cr3.getInstructor()));
		System.out.println("cr1 and cr3 have the same insturctor: " + (cr1.getInstructor() == cr3.getInstructor()));
